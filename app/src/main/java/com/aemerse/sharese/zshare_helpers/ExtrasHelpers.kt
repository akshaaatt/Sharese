...
import com.aemerse.sharese.selectors.SendOptionsAdapter
import com.aemerse.sharese.utils.getShareseFolder
import com.aemerse.sharese.utils.getLocalDpKey
import com.aemerse.sharese.utils.getLocalName
import com.aemerse.sharese.utils.wifi.WifiConstants
...
fun Activity.getDownloadFile(fileType: FileType, fileName: String): File {
    ...
    val file = File(getShareseFolder().canonicalPath + '/' + fileType + '/' + fileName)
